...
Run `pnpm db:seed` from the repo root to load the default admin account.
The seeded admin password is `Password123`:

| Email                | Role        |
| -------------------- | ----------- |
| `admin@tzw.test`     | `admin`     |

No sample extinguisher, inspection, maintenance, or extra user data is seeded.
