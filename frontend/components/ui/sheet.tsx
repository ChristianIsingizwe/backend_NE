		...
		<SheetPortal {...portalProps}>
			...
			<SheetViewport side={side} variant={variant}>
				<SheetPrimitive.Popup
					className={cn(
						"relative flex max-h-full min-h-0 w-full min-w-0 flex-col bg-popover text-popover-foreground shadow-[0_24px_60px_rgba(28,25,23,0.18)] transition-[opacity,translate] duration-200 ease-in-out will-change-transform data-ending-style:opacity-0 data-starting-style:opacity-0",
						side === "bottom" &&
						...
						variant === "inset" &&
							"sm:rounded-[var(--radius-2xl)] sm:border sm:**:data-[slot=sheet-footer]:rounded-b-[calc(var(--radius-2xl)-1px)]",
						className,
					)}
