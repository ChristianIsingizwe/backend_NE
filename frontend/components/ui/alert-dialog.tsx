		...
		<AlertDialogPortal {...portalProps}>
			...
			>
				<AlertDialogPrimitive.Popup
					className={cn(
						"relative row-start-2 flex max-h-full min-h-0 w-full min-w-0 max-w-lg origin-center flex-col rounded-[var(--radius-2xl)] border border-border bg-popover text-popover-foreground opacity-[calc(1-var(--nested-dialogs))] shadow-[0_24px_60px_rgba(28,25,23,0.18)] transition-[scale,opacity,translate] duration-200 ease-in-out will-change-transform data-ending-style:opacity-0 data-starting-style:opacity-0 sm:scale-[calc(1-0.1*var(--nested-dialogs))] sm:data-ending-style:scale-98 sm:data-starting-style:scale-98",
						bottomStickOnMobile &&
